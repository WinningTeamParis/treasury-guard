...
export default function Navbar() {
  ...
  return (
    <div style={{width: '90%', alignItems:'center', padding: '12px 24px', minHeight:'50px', height: '10%', borderBottom: '1px solid var(--black-10, rgba(28, 28, 28, 0.10))'}}>
        ...
        {showNot && 
        <div>
        <div id="toast-top-right" class="fixed flex items-center w-full max-w-xs p-4 space-x-4 z-40 text-gray-500 bg-white divide-x divide-gray-200  rounded-lg shadow top-15 right-5 dark:text-gray-400 dark:divide-gray-700 space-x dark:bg-gray-800" role="alert">
